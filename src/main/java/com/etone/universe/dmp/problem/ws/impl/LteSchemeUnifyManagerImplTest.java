...
public class LteSchemeUnifyManagerImplTest implements LteSchemeUnifyManager {

	public static final Logger logger = LoggerFactory
			.getLogger(LteSchemeUnifyManagerImplTest.class);
	...
	public String CityWorkNum(String xmlData) {
		...
		try {
			...
			// 3.先记录本次调用日志
			//gpConn = LteSchemeUnifyProcessor.saveLog(xmlData, gpConn);

			// 4.根据省工单号更新数据表的地市工单号字段
			//LteSchemeUnifyProcessor.updateCityCode(gpConn, dataMap);
