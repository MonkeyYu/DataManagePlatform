...
import com.etone.universe.dmp.problem.ImportGjProcessor;
 ...
 */
public class ImportGjTask extends ProblemTask {
	...
	public void execute() {
		...
		try {
			...
			if (rkFiles.list(CSV).length > 0) {
				...
				ImportGjProcessor importPro = new ImportGjProcessor(conn,
						sqlMap, this);
