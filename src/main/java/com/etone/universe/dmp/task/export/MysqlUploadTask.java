 ...
 */
public class MysqlUploadTask extends FtpTask {
    private static final Logger logger = LoggerFactory.getLogger(MysqlUploadTask.class);
    ...
    public void readConf() throws Exception {
        String configName="ftp.nokia.mysql.";
